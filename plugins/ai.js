const {
  ...
  smd(
    ...
    async (message, input) => {
      try {
        ...
        return await message.send(`*JINHUYK-MD-V1  ʙᴀʀᴅ ᴀɪ:*\n ${result}`, { quoted: message });
      } catch (error) {
  ...
  smd(
    ...
    async (_0x1c0160, _0x482db1) => {
        let astro = "JINHUYK-MD-V1 ᴄʜᴀᴛ ʙᴏᴛ"
      try {
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("JINHUYK-MD-V1• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("JINHUYK-MD-V1 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*JINHUYK-MD-V1 • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
