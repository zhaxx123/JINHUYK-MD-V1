  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://github.com/ChanJinhuyk/JINHUYK-MD-V1"
      );
      let _0x1c73f9 = (
        "\nJINHUYK-MD A simple Mutil Device WhatsApp Bot Created and Managed by KANG JINHUYK*" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Creator:* KANG JINHUYK\n  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/06") +
        "\n  *❲❒❳ Repo:* _https://github.com/ChanJinhuyk/JINHUYK-MD-V1_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
  ...
  async (_0x397531) => {
    try {
      ...
      let _0x53eb40 = (
        " *I am " +
        Config.botname +
        "*\n  *❲❒❳ About:* A Simple WhatsApp Bot Created By KANG JINHUYK*" +
        Config.ownername +
        "*.\n\n  *❲❒❳ Speed:* " +
        latensie.toFixed(4) +
        " ms\n  *❲❒❳ Uptime:* " +
